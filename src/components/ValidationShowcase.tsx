      ...
      <div className="w-full max-w-[960px] flex flex-col items-start gap-[24px]">
        ...
        <div className="w-full flex flex-col items-start gap-[24px]">
          ...
          <div className="w-full flex flex-row justify-between items-end">
            <img src="/assets/Review settings/st1.png" alt="Sketch 1" className="w-[186px] h-[148px] rounded-[12px] object-cover bg-[#F5F7F9]/40 -rotate-[4.94deg]" />
            <img src="/assets/Review settings/st2.png" alt="Sketch 2" className="w-[186px] h-[148px] rounded-[12px] object-cover bg-[#F5F7F9]/40 rotate-[1.5deg]" />
            <img src="/assets/Review settings/st3.png" alt="Sketch 3" className="w-[186px] h-[148px] rounded-[12px] object-cover bg-[#F5F7F9]/40 rotate-[2.09deg]" />
            <img src="/assets/Review settings/st4.png" alt="Sketch 4" className="w-[186px] h-[148px] rounded-[12px] object-cover bg-[#F5F7F9]/40 rotate-[2.09deg]" />
            <img src="/assets/Review settings/st5.png" alt="Sketch 5" className="w-[186px] h-[148px] rounded-[12px] object-cover bg-[#F5F7F9]/40 rotate-[2.09deg]" />
          </div>
          ...
          <div className="w-full flex flex-col items-start gap-[16px] mt-[16px]">
            ...
            <div className="w-full flex flex-col items-start gap-[4px] mt-[16px]">
              ...
              <div className="flex flex-col items-start gap-[10px] w-[540px]">
                {/* Row 1 */}
                <div className="w-full flex flex-row items-center gap-[12px]">
                  <div className="flex-1 flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Sequential flow</span>
                  </div>
                  ...
                  <div className="flex-[1.2] flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Dense configuration flow</span>
                  </div>
                </div>
                {/* Row 2 */}
                <div className="w-full flex flex-row items-center gap-[12px]">
                  <div className="flex-[1.2] flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Template-assisted setup</span>
                  </div>
                  <span className="font-inter font-normal text-[16px] text-[#535F6F]">vs</span>
                  <div className="flex-1 flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Manual setup</span>
                  </div>
                </div>
                {/* Row 3 */}
                <div className="w-full flex flex-row items-center gap-[12px]">
                  <div className="flex-[0.6] flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Views</span>
                  </div>
                  <span className="font-inter font-normal text-[16px] text-[#535F6F]">vs</span>
                  <div className="flex-[1.4] flex justify-center items-center px-[12px] py-[4px] border border-[#DADCDE]/60 rounded-[12px]">
                    <span className="font-inter font-normal text-[16px] text-[#3D495A] whitespace-nowrap">Multiple review cycles</span>
                  </div>
                </div>
              </div>
            </div>
